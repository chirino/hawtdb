...
public class MultiIndexApiTest {
    ...
    public void testManuallyCreateAndOpenIndex() throws IOException {
        ...
        Index<String, String> index1 = multiIndexFactory.create(page, "1", indexFactory1);
        Index<String, String> index2 = multiIndexFactory.create(page, "2", indexFactory2);
        ...
        index1 = multiIndexFactory.open(page, "1", indexFactory1);
        index2 = multiIndexFactory.open(page, "2", indexFactory2);
    ...
    public void testOpenOrCreateIndex() throws IOException {
        ...
        Index<String, String> index1 = multiIndexFactory.openOrCreate(page, "1", indexFactory1);
        Index<String, String> index2 = multiIndexFactory.openOrCreate(page, "2", indexFactory2);
        ...
        index1 = multiIndexFactory.openOrCreate(page, "1", indexFactory1);
        index2 = multiIndexFactory.openOrCreate(page, "2", indexFactory2);
