 ...
 *
 */
public class AsciiBufferMarshaller extends AbstractBufferMarshaller<AsciiBuffer> {
    public static final AsciiBufferMarshaller INSTANCE = new AsciiBufferMarshaller();
